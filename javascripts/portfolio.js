...
$(window).load(function(){
     ...
     function loadNextItem(){
               ...
               $('html, body').animate({scrollTop: ($('.works-content-container').offset().top - 50)},'slow', function(){
                    $('div#works_item').slideUp(300, function(){
                         $('div.works-content-container').empty();
                         $('div.works-content-container').append('<div class="loading" style="display: none;"></div>');
                         $('div.loading').slideDown(500);
                         $('div.works-content-container').delay(500).queue(function( nxt ) {
                         $(this).load(source2, function(){
                                   $('#item_slider').flexslider({ controlNav: false, prevText: "<", nextText: ">" });
                                   $('div#works_item').slideDown(500, function(){
                                             ...
                                             $('#control_buttons a#close').click(function(){
                                                       $('div#works_item').slideUp(1000, function(){
     ...
     $(".works-gallery .works-item a.more_info").click(function(){

               var source = $(this).attr("href");
                // $('div#filter_wrapper').slideUp(300, function(){
                         $('div.works-content-container').append('<div class="loading"></div>');
                         // $('html,body').animate({scrollTop: $("#portfolio-wrap").offset().top - 150},'slow', function(){
                               $('html, body').animate({scrollTop: ($('.works-content-container').offset().top - 50)},'slow', function(){
                                   $('div.works-content-container').load(source, function(){
                                             $('div.loading').remove();
                                             $('#item_slider').flexslider({ controlNav: true, prevText: "<", nextText: ">" });
                                             
                                             $('div#works_item').slideDown(1500, function(){
